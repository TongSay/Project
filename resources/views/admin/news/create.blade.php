...
@section('content')
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('globle.Action.Create') }} {{ __('globle.News') }}
            </li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('globle.Action.Create') }} {{ __('globle.News') }}</li>
                        </ol>
                    </h4>

                    <form class="cmxform" action="{{ route('news.store') }}" method="POST"
