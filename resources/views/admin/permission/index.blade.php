...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
      <h4 class="mb-3 mb-md-0">{{__('globle.Welcome_to')}} {{__('sidebar.Permission')}}</h4>
    </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form action="{{route('permissions.destroy',[$permission->id])}}" method="POST"> @csrf
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h5 class="modal-title" id="exampleModalLabel">{{__('globle.Action.Delete')}} {{__('sidebar.Permission')}}</h5>
