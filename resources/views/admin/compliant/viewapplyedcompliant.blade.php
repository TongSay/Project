...
@section('content')
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('applyed-compliant') }}">{{ __('globle.Action.Back') }}</a>
            </li>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled class="form-control @error('name') is-invalid @enderror" name="name"
                                            value="{{ $viewapplyedcompliant->name }}" required="" type="text">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled class="form-control @error('job') is-invalid @enderror" name="job"
                                            value="@if ($viewapplyedcompliant->loantype) {{ $viewapplyedcompliant->loantype->{'title_' . app()->getLocale()} }}
                                          @else
                                            Unknow @endif"
                                            name="job" type="text">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled class="form-control @error('dob') is-invalid @enderror"
                                            value="{{ $viewapplyedcompliant->created_at->format('d-M-Y') }}" id="dob"
                                            name="dob" type="text">
                        ...
                        <div class="col-lg-6 col-sm-6 d-flex flex-row">
                            ...
                            <div class="form-group">
                                ...
                                @if ($viewapplyedcompliant->status == null)
                                    ...
                                    <div class="modal fade" id="exampleModal{{ $viewapplyedcompliant->id }}"
                                    ...
                                    <div class="modal fade" id="rejectModal{{ $viewapplyedcompliant->id }}"
                                        tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
