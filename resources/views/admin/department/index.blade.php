...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
      <h4 class="mb-3 mb-md-0">{{__('globle.Welcome_to')}} {{__('sidebar.Department')}}</h4>
    </div>
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                @if (@isset(auth()->user()->role->permission['name']['department']['can-delete'])) 
                                                ...
                                                <button type="button"  class="btn btn-link" data-toggle="modal" data-target="#exampleModal{{$department->id}}">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <form action="{{route('departments.destroy',[$department->id])}}" method="POST"> @csrf
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <h5 class="modal-title" id="exampleModalLabel">Deleting Department</h5>
