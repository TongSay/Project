...
@section('content')
            ...
            <nav class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page">{{__('globle.Action.Create')}} {{__('sidebar.Department')}}</li>
					</ol>
			</nav>
					...
					<div class="col-lg-6 grid-margin stretch-card">
						<div class="card">
							<div class="card-body">
								...
								<form class="cmxform"  action="{{route('departments.store')}}" method="POST">@csrf
									<fieldset>
