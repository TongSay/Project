        ...
        <div class="col-sm-12 col-md-6 d-flex mb-3">
            ...
            <div class="align-self-center">
                ...
                <a href="{{route('jobtypes.create')}}">
                    ...
                    <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
                        <i class="btn-icon-prepend" data-feather="plus-square"></i> {{__('globle.Types')}}
                        {{__('sidebar.Job')}}
                    </button>
                            ...
                            <tbody>
                                ...
                                <tr style="background: rgba(170, 170, 170, 0.658);">
                                    ...
                                    <td>
                                        ...
                                        <div class="modal fade" id="exampleModal{{ $applyloan->id }}" tabindex="-1"
                                        ...
                                        <div class="modal fade" id="rejectModal{{ $applyloan->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                        ...
                                        <button type="button" class="btn btn-second" data-toggle="modal"
                                            data-target="#exampleModal{{ $applyloan->id }}" data-whatever="@mdo"> <i
                                                    ...
                                                    <div class="modal-body">
                                                        <form>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="message-text"
                                                                    class="col-form-label">Message:</label>
                                                                <textarea disabled class="form-control" name="comments"
                                                                    id="message-text"
