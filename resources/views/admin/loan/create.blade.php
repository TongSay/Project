...
@section('content')
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('globle.Action.Create') }}
                {{ __('globle.Loans') }}
            </li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('globle.Action.Create') }} {{ __('globle.Loans') }}</li>
                        </ol>
                    </h4>

                    <form class="cmxform" action="{{ route('loans.store') }}" method="POST"
                                    ...
                                    @foreach (config('app.available_locales') as $locale)
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="title_{{ $locale }}"
                                                id="title_{{ $locale }}" value="{{ old('title_' . $locale) }}"
                                                required autofocus />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="description_{{ $locale }}"
                                                ...
                                                rows="5">{{ old('description_' . $locale) }}</textarea>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <center>
                                            ...
                                            <img src="{{ asset('assets/images/placeholder.jpg') }}" alt="My Profile"
