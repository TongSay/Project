...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">{{__('globle.Action.Update')}} {{__('sidebar.User')}}
        </li>
    </ol>
</nav>
    ...
    <div class="col-lg-6 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form class="cmxform" action="{{ route('users.update',[$user->id])}}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <center>
                                        ...
                                        <br>
                                            ...
                                            <img src="{{asset ('Profile')}}/{{$user->image}}" alt="My Profile" id="output" style="width: 150px; height: 150px; border-radius:50%; object-fit: cover;"/>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('name') is-invalid @enderror" id="name"
                                                name="name" value="{{$user->name}}" required="" type="text">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('address') is-invalid @enderror"
                                                id="address" name="address" value="{{$user->address}}" type="address">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('mobile_number') is-invalid @enderror"
                                                id="mobile_number" name="mobile_number" value="{{$user->mobile_number}}"
                                                type="number">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('designation') is-invalid @enderror"
                                                id="designation" name="designation" value="{{$user->designation}}"
                                                type="text">
