                        ...
                        <div class="col-lg-4 col-sm-4">
                            <div class="form-group">
                                ...
                                <center>
                                    ...
                                    <a href="{{ asset('CV')}}/{{$viewapplyedjob->cv}}"
                                        download="{{$viewapplyedjob->cv}}">
                                        <p>Download CV</p>
                                    </a>
                                ...
                                <center>
                                    ...
                                    <a href="{{ asset('NationalCard')}}/{{$viewapplyedjob->national_card}}"
                                        download="{{$viewapplyedjob->national_card}}">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled class="form-control @error('position') is-invalid @enderror"
                                            name="position" value="{{$viewapplyedjob->genderapplyedjob->name}}"
                                            required="" type="text">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input disabled class="form-control @error('other_job') is-invalid @enderror"
                                            value="{{$viewapplyedjob->other_job}}" name="other_job" type="other_job">
                            ...
                            <div class="form-group">
                                    ...
                                    @if ($viewapplyedjob->status == null)
                                        ...
                                        <div class="modal fade"
                                            id="exampleModal{{ $viewapplyedjob->id }}" tabindex="-1"
                                        ...
                                        <div class="modal fade"
                                            id="rejectModal{{ $viewapplyedjob->id }}" tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalLabel"
                                            aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
