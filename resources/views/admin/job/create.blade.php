...
@section('content')
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('globle.Action.Create') }} {{ __('sidebar.Job') }}
            </li>
        </ol>
    </nav>
    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ __('globle.Action.Create') }} {{ __('sidebar.Job') }}</li>
                        </ol>
                    </h4>

                    <form class="cmxform" action="{{ route('job.store') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="id_job_type" id="id_job_type"
                                            ...
                                            @foreach (App\Models\JobType::all() as $jobtype)
                                                ...
                                                <option value="{{ $jobtype->id }}">{{ $jobtype->{'title_' . app()->getLocale()} }}</option>
