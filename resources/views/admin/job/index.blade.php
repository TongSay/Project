...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
      <h4 class="mb-3 mb-md-0">{{__('globle.Welcome_to')}} {{__('sidebar.Job')}}</h4>
    </div>
                        ...
                        <div class="col-sm-12 col-md-6 d-flex mb-3">
                            ...
                            <div class="align-self-center">
                                ...
                                <a href="{{route('job.create')}}">
                                    ...
                                    <button type="button" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
                                        <i class="btn-icon-prepend" data-feather="plus-square"></i>{{__('sidebar.Job')}}
                                      </button>
                      ...
                      <table id="dataTableExample" class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="py-6">{{__('globle.Types')}} {{__('sidebar.Job')}}</th>
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ Str::limit($job->{'title_'.app()->getLocale()},50) }}</td>
                            <td>{{ $job->jobtype->{'title_'.app()->getLocale()} }}</td>
                            ...
                            <td>
                              ...
                              @endif
                                               ...
                                               @if (@isset(auth()->user()->role->permission['name']['job']['can-delete']))
                                                <button type="button"  class="btn btn-link" data-toggle="modal" data-target="#exampleModal{{$job->id}}">
