...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
      <h4 class="mb-3 mb-md-0">{{__('globle.Welcome_to')}} {{__('sidebar.Roles')}}</h4>
    </div>
          ...
          <tr>
            ...
            <td>
                ...
                @if(isset(auth()->user()->role->permission['name']['role']['can-delete'])) 
                                ...
                                <button type="button"  class="btn btn-link" data-toggle="modal" data-target="#exampleModal{{$role->id}}">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <form action="{{route('roles.destroy',[$role->id])}}" method="POST"> @csrf
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <h5 class="modal-title" id="exampleModalLabel">{{__('globle.Action.Delete')}} {{__('sidebar.Roles')}}</h5>
