            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="contact-right">
                        <form action="{{ route('applyloanid.storeapplyloan',[$loan->id])}}" method="POST" enctype="multipart/form-data" class="form-contact-right"> @csrf
                            <div class="input-row">
                                <div class="input-name">
                                    <label for="message" class="heading-features"> {{__('globle.form.choose')}} {{__('sidebar.loan')}} <strong
                                            style="color: red;">*</strong></label>
                                            <input type="text"​ disabled name="id_loan" class="input-contact" value="{{ $loan->{'title_'.app()->getLocale()} }}">
                                </div>
                            ...
                            <div class="input-row">
                                ...
                                <div class="input-email">
                                    <label id="email" class="heading-features">{{__('globle.form.upload')}} {{__('globle.form.nidc')}}  <strong style="color: red;">*</strong>
                                    </label>
